...
<body>
<form name="form1" method="post" action="arata_rezultate_student.php" >
<div align="center">
	<table border="0" width="100%" cellspacing="1" height="100%" id="table1">
		...
		<tr >
			...
			<?php
			$id=$_GET["id"];
			$sql="select s.*, q.* from test s, intrebare q where q.i_test_id=s.t_id and s.t_id =".$id;
			...
			if ($row_count>0)
			{
				...
				echo("Rezultate pentru testul : <b>".$sm_name."<br></b> &nbsp;</b>");
				$i=0;
				...
				{	
					...
					echo("		<tr>");
					echo("				<td>");
					echo("				<table   width='".$gr_width1."' cellspacing='0' cellpadding='0' bgcolor='#00FF00' height='15' id='table4'>");
					echo("					<tr>");
					echo("					<td> </td>");
					echo("					</tr>");
					echo("				</table>");
					...
					echo("	</tr>");
					echo("	<tr>");
					echo("		<td align='left' valign='top' width='83' style='padding-left: 6px'>Varianta B</td>");
					...
					echo("	</tr>");
					echo("	<tr>");
					echo("		<td align='left' valign='top' width='83' style='padding-left: 6px'>Varianta C</td>");
					...
					echo("	 </tr>");
					echo("	 <tr>");
					echo("	 	<td align='left' valign='top' width='83' style='padding-left: 6px'>Varianta D</td>");
