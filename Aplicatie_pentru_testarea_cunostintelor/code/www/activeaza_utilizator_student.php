...
session_start();
if(!isset($_SESSION['username']) || trim($_SESSION['username'])=='' || $_SESSION['usertype']=='Student')
{
...
$mode='';
	...
	if ($mode=='A')
	{
		$result1=mysqli_query($con,"update utilizator set u_data_activare=sysdate() where u_id=".$id);
		header("location:activeaza_utilizator_student.php"); 	
...
<body>
<form name="form1"   method="post" action="activeaza_utilizator_student.php" >
<div align="center">
...
&nbsp;<?php
					...
					//get feedback
					$result = mysqli_query($con,"select * from utilizator where u_tip='Student' order by u_data_creare desc");
